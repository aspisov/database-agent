...
Your task is to analyze the visualization request and convert it into a precise data retrieval query. Follow these guidelines:
...
4. Think step by step before producing the final query.
Examples:
